const data = {
  ...
  itemsliderCategory: [
    ...
    {
      title: 'Fitness',
      image: '/images/product/3-05.png',
      link: '/category',
    },
    {
      title: 'Books',
      image: '/images/product/3-06.png',
      link: '/category',
    },
    {
      title: 'Hand Tools',
      image: '/images/product/4-01.png',
      link: '/category',
    },
    {
      title: 'Real Estate',
  ...
  productss: [
    {
      ...
      price: '112',
      title: 'Samsung Tab A7 Lite',
      slug: 'SamsungTabA7Lite',
      description: 'Samsung Tab A7 Lite,Andriod11-silver',
    ...
    },
    {
      ...
      description: 'Samsung Galaxy Tab/Andriod 10-grey',
      protected: 'Insurance Protected',
      adImage: '/images/poster/image2.png',
      posterName: 'John Doe',
      category: 'electronic',
    },
    {
      ...
      slug: 'InfinixHot11s',
      description: 'Infinix Hot 11s/Andriod 11-Green Wave',
      protected: 'Insurance Protected',
    ...
    },
    {
      ...
      slug: 'XboxWirelessController',
      description: 'Official Xbox Wireless Controller{Limited Edition}',
      protected: 'Insurance Protected',
      adImage: '/images/poster/image2.png',
    ...
    },
    {
      ...
      price: '111.04',
      title: 'Car Handle For Ps4',
      slug: 'CarHandleForPs4',
      description: 'Car Handle For Ps4/XBOX/Andriod',
      protected: 'Insurance Protected',
      adImage: '/images/poster/image1.png',
      posterName: 'John Doe',
      category: 'motors',
    },
    {
      ...
      price: '107',
      title: 'TCL Sound Bar System',
      slug: 'TCLSoundBarSystem',
      description: 'TCL Sound Bar System(TC3010) 2.1CH',
    ...
    },
    {
      ...
      slug: 'MobilePhoneHolder',
      description: 'Mobile Phone Holder Stand Adjustable',
      protected: 'Insurance Protected',
      adImage: '/images/poster/image3.png',
      posterName: 'Jacob Jones',
      category: 'motors',
    },
    {
      ...
      price: '50',
      title: 'PolyStar 32 Inch',
      slug: 'PolyStar32Inch',
      description: 'PolyStar 32 Inch UHD Smart Tv',
      protected: 'Insurance Protected',
      adImage: '/images/poster/image1.png',
      posterName: 'Jacob Jones',
      category: 'fittness',
    },
    {
      ...
      price: '150',
      title: 'Flexible Holder Arm',
      slug: 'FlexibleHolderArm',
      description: 'New Flexible Holder Arm Lazy Mobile Phone',
      protected: 'Insurance Protected',
      adImage: '/images/poster/image2.png',
      posterName: 'Jacob Jones',
      category: 'fittness',
    },
    {
      ...
      price: '12',
      title: 'Samsung T400 2 Inches',
      slug: 'SamsungT4002Inches',
      description: 'Samsung T400 2 Inches All-In-one Standby',
      protected: 'Insurance Protected',
      adImage: '/images/poster/image3.png',
      posterName: 'Jacob Jones',
      category: 'books',
    },
    {
      ...
      image: 'images/product/3-01.png',
      price: '102',
      title: 'Bluetooth Earphone Wireless',
      slug: 'BluetoothEarphoneWireless',
      description: 'Bluetooth Earphone True Wireless Stereo Built',
      protected: 'Insurance Protected',
      adImage: '/images/poster/image1.png',
      posterName: 'Jacob Jones',
      category: 'books',
    },
    {
      ...
      image: 'images/product/3-02.png',
      price: '110',
      title: 'Edifier Gm3 Wireless Earbuds',
      slug: 'Edifier Gm3WirelessEarbuds',
      description: 'Edifier Gm3 Wireless Earbuds, Bluetooth 5.0',
      protected: 'Insurance Protected',
      adImage: '/images/poster/image2.png',
      posterName: 'Jacob Jones',
      category: 'Hand tools',
    },
    {
      ...
      image: 'images/product/3-03.png',
      price: '112',
      title: 'Finit Charge 4 Fittness And Activity Tracker',
      slug: 'FinitCharge4FittnessAndActivityTracker',
      description: ' Fittness And Activity Tracker Built with Suspence',
      protected: 'Insurance Protected',
      adImage: '/images/poster/image2.png',
      posterName: 'John Doe',
    ...
    },
    {
      ...
      image: 'images/product/3-04.png',
      price: '1124',
      title: 'Polarized Bluetooth Sunglasses',
      slug: 'PolarizedBluetoothSunglasses',
      description: 'Polarized Bluetooth Sunglasses with Pedometer',
      protected: 'Insurance Protected',
      adImage: '/images/poster/image2.png',
      posterName: 'Jacob Jones',
      category: 'Real Estate',
  ...
  Category: [
      {title: 'smartphones' , brand: [{a:'Apple'},{a:'Samsung'},{a:'OPPO'},{a:'Huawei'},{a:'Infinix'}]  },
      {title: 'laptops',brand: [{a:'Microsoft Surface'},{a:'HP Pavilion'}] },
      {title: 'fragrances', brand: [{a:'Impression of Acqua Di Gio'},{a:'Royal_Mirage'},{a:'Fog Scent Xpressio'},{a:'Al Munakh'}]},
      {title: 'skincare', brand: [{a:"L'Oreal Paris"},{a:'Lord - Al-Rehab'},{a:'ROREC White Rice'},{a:'Fair & Clear'},{a:'Saaf & Khaas'}]},
      {title: 'groceries', brand: [{a:'Bake Parlor Big'},{a:'Baking Food Items'},{a:'fauji'},{a:'Dry Rose'},]},
      {title: 'home-decoration', brand: [{a:'Boho Decor'},{a:'Flying Wooden'},{a:'LED Lights'}, {a:'luxury palace'},{a:'Golden'}] },
  ],
  brand: {
    smartphones: [
        {a:'Apple'},{a:'Samsung'},{a:'OPPO'},'Huawei'
    ],
    laptops: [{a:'Microsoft Surface'},{a:'HP Pavilion'}],
    fragrances:[{a:'Impression of Acqua Di Gio'},{a:'Royal_Mirage'},{a:'Fog Scent Xpressio'},{a:'Al Munakh'}],
    skincare: [{a:"L'Oreal Paris"},{a:'Lord - Al-Rehab'},{a:'ROREC White Rice'},'Fair & Clear','Saaf & Khaas'],
    groceries:[{a:'Bake Parlor Big'},'Baking Food Items','fauji','Dry Rose',],
    'home-decoration':[{a:'Boho Decor'},'Flying Wooden','LED Lights', 'luxury palace','Golden'],
    //   {title: 'Samsung'},
    //   {title: 'OPPO'},
    //   {title: 'Huawei'},
  ...
  product: [
    {
      title: 'iPhone12Pro',
      description: 'An apple mobile which is nothing like Apple fruit',
      price: 549,
      adImage: "https://robohash.org/hicveldicta.png",
      posterName: 'John Doe',
    ...
    },
    {
      ...
      price: 46,
      adImage: "https://robohash.org/hicvqqeldicta.png",
      posterName: 'Anne Marie',
    ...
    },
    {
      ...
      price: 14,
      adImage: "https://robohash.org/hicveldictra.png",
      posterName: 'Prevail Ayodele',
    ...
    },
    {
      ...
      price: 51,
      adImage: "https://robohash.org/hicvewldicta.png",
      posterName: 'Prevail Ayodele',
      discountPercentage: 15.58,
       protected: 'Insurance Protected',
      slug: '4.441',
    ...
    },
    {
      ...
      price: 60,
      adImage: "https://robohash.org/hicveldfricta.png",
      posterName: 'Aaliyah Omotolaini',
